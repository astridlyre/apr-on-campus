...
import { formatDateWithoutTime, getFormDataValue } from "~/utils";
...
export default function IncidentPage() {
	...
	return (
		<Section className="py-4 sm:py-6 md:py-12">
			<div className="space-y-8 md:rounded-lg md:border md:border-divider md:bg-bg0 md:p-6">
				...
				<section>
					...
					<ul className="space-y-2">
						...
						<ListItem>
							...
							<strong>{incident.location.map(D.get("name")).join(", ")}</strong>
						</ListItem>
						<ListItem>
