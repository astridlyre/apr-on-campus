  ...
  return (
    <Layout>
      <Section className="mt-4 sm:mt-8 xl:mt-12">
        ...
        <Paragraph>
          Anti-Palestinian racism (APR) fosters exclusion, fear, and hostility,
      ...
      <Section>
        <Heading level={2}>What APR Looks Like</Heading>
      ...
      <Section>
        ...
        <Paragraph>
          While we have highlighted numerous examples of Anti-Palestinian Racism
          (APR) within post-secondary institutions, it is important to recognize
          that APR is deeply ingrained and pervasive throughout the entire
          education system. This systemic presence not only reinforces its
          normalization but also makes it easier for such discrimination to
          persist and escalate on university and college campuses.
        </Paragraph>
