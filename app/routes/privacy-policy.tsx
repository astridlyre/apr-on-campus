...
export default function PrivacyPolicy() {
  return (
    <Section title="Privacy Policy">
      ...
      <UnorderedList>
        <li>
          Contact information, such as your email address, when you provide it.
        </li>
      ...
      <UnorderedList>
        <li>
          <strong>Emails or contact information:</strong> These are kept private
        ...
        <li>
          <strong>Session data:</strong> This is used solely to track how users
          interact with our website and is never shared externally.
        </li>
      </UnorderedList>
      ...
      <Paragraph>
        ...
        here, and your continued use of the website means you accept the updated
        policy.
      </Paragraph>
